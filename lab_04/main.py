...
if __name__ == '__main__':
    ...
    co_2 = least_squares(f_least_squares, array([-1, 1, 1, 1]), args=(rational_approx, signal), xtol=eps, max_nfev=1000)
    ...
    co_3 = dual_annealing(f_least_squares, [(-5, 5), (-5, 5), (-5, 5), (-5, 5)], (rational_approx, signal), maxiter=1000)
    ...
    co_4 = differential_evolution(f_least_squares, [(-5, 5), (-5, 5), (-5, 5), (-5, 5)], (rational_approx, signal), maxiter=1000, tol=eps)
